...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public SeedingService(SalesWebMVCContext conext)
        {
            _context = conext;
        }
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@mail.br", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Maria Green", "mnaria@mail.br", new DateTime(1979, 12, 31), 3500.0, d2);
            Seller s3 = new Seller(3, "Alex Grey", "alex@mail.br", new DateTime(1988, 1, 15), 2200.0, d1);
            Seller s4 = new Seller(4, "Martha Red", "martha@mail.br", new DateTime(1993, 11, 30), 3000.0, d4);
            Seller s5 = new Seller(5, "Donald Blue", "donald@mail.br", new DateTime(2000, 3, 4), 4000.0, d3);
            Seller s6 = new Seller(6, "Alex Pinx", "pink@mail.br", new DateTime(1997, 3, 4), 3000.0, d2);
